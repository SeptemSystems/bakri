        ...
        <section class="about-section sec-padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-5">
                        <div class="left-side">
                            <img src="images/resource/businessman-2.png" />
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="right-side">
                            <h4>Helping and providing best service to our client business over 20 years!!</h4>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="team-box">
                            <div class="team-head">
                                <img src="images/resource/team2.jpg" class="img-responsive mauto" alt="">
                                <div class="social">
                                    <ul>
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="team-box">
                            <div class="team-head">
                                <img src="images/resource/team3.jpg" class="img-responsive mauto" alt="">
                                <div class="social">
                                    <ul>
                                        <li class="facebook-icon">
                                            <a href="#">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="team-box">
                            <div class="team-head">
                                <img src="images/resource/team4.jpg" class="img-responsive mauto" alt="">
                                <div class="social">
                                    <ul>
                                        <li class="facebook-icon">
                                            <a href="#">
            ...
            <div class="container">
                ...
                <div class="row testmonrow">
                    <div class="col-sm-6">
                        <div class="testwrp">
                            <div class="single-testm">
                                <div class="client-image"><img src="images/clients/client1.jpg" class="testmimg" alt="" width="100" height="100"> </div>
                    ...
                    <div class="col-sm-6">
                        <div class="testwrp">
                            <div class="single-testm">
                                <div class="client-image"><img src="images/clients/client2.jpg" class="testmimg" alt="" width="100" height="100"> </div>
                                <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et.</p>
                                <h4>John White<small>Director</small></h4>
                            </div>
                        </div>
