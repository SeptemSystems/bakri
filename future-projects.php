...
<body>
    <div class="page-wrapper">
        ...
        <!--Page Title-->
        <section class="page-title" style="background-image:url(images/background/terminal-depots.jpg);">
        ...
        <div class="container" style="padding-bottom:60px; padding-top:60px;">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-6">
                        <div class="weltext">
                            <h2 style="color:#253653;"><b>Future Projects</b></h2>
                            

                            <p class="readable">
                                Our terminal at <b style="color:#0d57b6;">Shikarpur</b> with storage capacity of 6,000 MT High Speed Diesel (HSD) and 400
                                MT Motor Gasoline (MS) is in construction phase. Shikarpur Terminal will be connected with
                                Parco Pumping Station Shikarpur through an off-take pipeline to receive HSD pumped from
                                Karachi through White Oil Pipeline (WOP).</p>

                              
                                
                                  <p class="readable">    
                                    The new terminals in <b style="color:#0d57b6;">Mehmood Kot, Gatti, and Thaliyan Oil City</b> are in the planning phase for
                                    which the lands have been acquired.</p>

                        </div>
                    </div>

                    <div class="col-lg-5 col-md-3 col-sm-6" style="margin-top:10px;">
                        <div class="welimage">
                            <!--<img src="images/gallery/welimg.jpg" />-->
                ...
                <div class="mixitup-gallery">
                    ...
                    <div class="filter-list row clearfix">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 project-item mix mix_all  all meterial">
                            <div class="switem">
                                <a href="#">
                                    <img src="images/clients/revive.png">
                                    <div class="swhoverbox">
                                        <div class="projinrtext">
                                            <h3>Meterial Engineering</h3>
